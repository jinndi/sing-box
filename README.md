...
| `TUN_NAME`        | `singbox`                 | Name for the sing-box tun interface                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `PROXY_LINK`       | -                       | Proxy connection link. See: [Proxy links](https://github.com/jinndi/sing-box?tab=readme-ov-file#proxy-links)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `ROUTE_CIDR`       | -                       | A comma-separated list IPv4 and IPv6 CIDR addresses to which the routing rules (all options below) will be applied. If no addresses are specified, the routing rules will apply to all traffic. Example: `10.0.0.1/24,10.8.0.1/24,fd42:42:42::1/64`                                                                                                                                                                                                                                                                                                                                                                   |
